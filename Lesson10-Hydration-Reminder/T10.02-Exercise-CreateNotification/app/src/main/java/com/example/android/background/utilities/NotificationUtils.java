...
public class NotificationUtils {
    public static int PENDING_INTENT_ID = 120;
    public static String WATER_REMINDER_NOTIFICATION_CHANNEL_ID= "reminder_notification_channel";
    public static int WATER_REMINDER_NOTIFICATION_ID = 222;
