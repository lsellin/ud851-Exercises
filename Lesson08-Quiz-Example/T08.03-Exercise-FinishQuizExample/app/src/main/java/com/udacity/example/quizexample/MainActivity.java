...
public class MainActivity extends AppCompatActivity {
    ...
    public void nextWord() {
        ...
        if (mData != null){
            ...
            String word= mData.getString(mDefCol);
            String def = mData.getString(mWordCol);
            mDefinition.setText(word);
            mWord.setText(def);
            Log.v(TAG, "Got row: "+word+ " - "+def );
        }
        else {
            Log.v(TAG, "Error: Cursor was not initialized!");
